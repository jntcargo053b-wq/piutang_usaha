                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    trailing: PopupMenuButton<String>(
                      ...
                      itemBuilder: (_) => [if (transaksi.sisa > 0) const PopupMenuItem(value: 'bayar', child: Text('Bayar')), const PopupMenuItem(value: 'edit', child: Text('Edit')), const PopupMenuItem(value: 'hapus', child: Text('Hapus'))],
                    ),
