...
class _HomeScreenState extends State<HomeScreen> {
                ...
                children: [
                  ...
                  Card(
                    child: topCustomers.isEmpty
                        ...
                        : Column(
                            children: topCustomers.take(5).map((r) {
                              final name = '${r['nama'] ?? ''}';
                              final value =
                                  (r['sisa_piutang'] as num?)?.toInt() ?? 0;
                              return ListTile(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [scheme.primary, Color.lerp(scheme.primary, const Color(0xFF42A5F5), .55)!],
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            Formatter.rupiah(summary['sisa_piutang'] ?? 0),
            style: const TextStyle(
              color: Colors.white,
              fontSize: 28,
          ...
          Row(
            children: [
              Expanded(
                child: _heroValue('Total Kredit', summary['total_kredit'] ?? 0),
              ),
              const SizedBox(width: 16),
              Expanded(
                child: _heroValue('Total Dibayar', summary['total_dibayar'] ?? 0),
              ),
            ],
          ),
        ],
  ...
  Widget _heroValue(String label, int value) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            label,
  ...
  Widget _agingRow(String label, int value) => ListTile(
        dense: true,
